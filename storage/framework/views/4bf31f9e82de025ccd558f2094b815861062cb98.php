              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="status" id="inputStatus">
                    <option value="1" <?php if($webSettings->status == 1): ?> <?php echo e('Selected '); ?> <?php endif; ?>>Active</option>
                    <option value="2" <?php if($webSettings->status == 2): ?> <?php echo e('Selected '); ?> <?php endif; ?>>Deactive</option>
                  </select>
                </div>
              </div>
              <!-- /.card-body -->
