<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?php echo e(secure_url('/admin')); ?>" class="brand-link">
    <img src="<?php echo e(asset('admin_dashboard/assets/img/AdminLTELogo.png')); ?>" alt="AdminLTE Logo"
      class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light"><?php echo e(config('app.name', 'CMS')); ?></span>
  </a>
