              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="status" id="inputStatus">
                    ...
                    <option value="0" <?php if($user->status == 0): ?> <?php echo e('Selected '); ?> <?php endif; ?>>Deactive</option>
                  </select>
                </div>
              </div>
              <!-- /.card-body -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\lara_cms\resources\views/dashboard/admin/user/edit.blade.php ENDPATH**/ ?>