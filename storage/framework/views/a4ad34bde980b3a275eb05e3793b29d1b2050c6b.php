<nav class="main-header navbar navbar-expand navbar-dark">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="<?php if($webSettings): ?> <?php echo e($webSettings->site_url); ?> <?php else: ?> <?php echo e(__('#')); ?> <?php endif; ?>" class="nav-link"
...
</nav><?php /**PATH E:\laragon\www\lara_cms\resources\views/dashboard/admin/includes/header.blade.php ENDPATH**/ ?>