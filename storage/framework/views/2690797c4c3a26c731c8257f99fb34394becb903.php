              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="level" id="inputLevel">
                    <option value="0" <?php if($role->level === 0): ?> <?php echo e(__('selected')); ?> <?php endif; ?>>Level 0</option>
                    <option value="1" <?php if($role->level === 1): ?> <?php echo e(__('selected')); ?> <?php endif; ?>>Level 1</option>
                    <option value="2" <?php if($role->level === 2): ?> <?php echo e(__('selected')); ?> <?php endif; ?>>Level 2</option>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="status" id="inputStatus">
                    <option value="1" <?php if($role->status === 1): ?> <?php echo e(__('selected')); ?> <?php endif; ?>>Active</option>
                    <option value="0" <?php if($role->status === 0): ?> <?php echo e(__('selected')); ?> <?php endif; ?>>Deactive</option>
                  </select>
                </div>
              </div>
              <!-- /.card-body -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\lara_cms\resources\views/dashboard/admin/role/edit.blade.php ENDPATH**/ ?>